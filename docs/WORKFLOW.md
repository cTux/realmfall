...
- For hook behavior, staged-quality scope, and pre-push verification policy, use `docs/rules/60-testing-and-documentation.md` and the testing-tooling spec instead of repeating those details here.
...
- For recurring CI, shell-safety, dependency-refresh behavior, and command-scope details, defer to `docs/rules/60-testing-and-documentation.md` and `docs/specs/reference/technical-solutions/testing-and-quality-tooling/spec.md`.
...
- For wording hygiene, spec-update expectations, and sync rules for generated AI instruction files, defer to `docs/rules/60-testing-and-documentation.md`.
