...
- Keep Biome responsible for the migrated ESLint-compatible arrow-return, React Hooks, and React Fast Refresh checks so repo-specific JS and TS lint ownership does not drift back into `eslint.config.js`.
