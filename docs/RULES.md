...
- Keep the pre-commit hook aligned with the local quality bar. It should run the repository test suite in addition to version, typecheck, and lint enforcement so broken tests are blocked before commit.
