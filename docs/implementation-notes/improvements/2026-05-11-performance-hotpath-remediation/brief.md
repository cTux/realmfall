...
1. `packages/client-web/src/app/App/world/tileResolution/useWorldTileResolutionLifecycle.ts`
...
2. `packages/client-web/src/app/App/world/pixiWorldHoverInteractions.ts`
...
3. `packages/client-web/src/app/App/usePixiWorld.ts` and
