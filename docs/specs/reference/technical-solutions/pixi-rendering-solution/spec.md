...
- Cloud animation layers follow world-map pan and movement transitions at half-speed parallax, wrap their offset through the cloud travel span so long-distance travel does not push the entire layer off-screen, and render pronounced lower shadow drops than the visible cloud sprites.
