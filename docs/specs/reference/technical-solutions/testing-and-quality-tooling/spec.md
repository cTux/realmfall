...
- The current startup bundle thresholds are derived from the live production build graph: `index` `4.743 kB`, `App` `78.410 kB`, `background-audio` `54.420 kB`, `react-dom-vendor` `199.966 kB`, `state` `532.132 kB`, `en` `109.450 kB`, `pixi` `549.560 kB`, and `1.470000 MB` for total startup JS.
