...
- The current startup bundle thresholds are derived from the latest production build sizes with roughly 10 percent headroom: `index` `4.743 kB`, `App` `78.410 kB`, `react-core` `8.689 kB`, `react-dom-vendor` `199.966 kB`, `state` `532.132 kB`, `en` `109.450 kB`, `pixi` `549.560 kB`, and `1.449695 MB` for total startup JS.
