...
- Broad UI coverage is split across focused suites such as `src/ui/ui.test.tsx`, `src/ui/uiRecipeBook.test.tsx`, and `src/ui/uiWindowShells.test.tsx` instead of one umbrella component test file.
