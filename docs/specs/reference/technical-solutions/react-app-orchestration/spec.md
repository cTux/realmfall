...
- `useHexInfoWindowPromotion` owns the structure, loot, and combat auto-open or auto-close rules for hex content while preserving a manual empty-hex toggle until the player closes that window again.
