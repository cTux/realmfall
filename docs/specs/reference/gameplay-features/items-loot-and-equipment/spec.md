...
- Generated artifacts and equipment use deterministic icon selection from curated icon pools while their per-instance stats are derived from tier and rarity.
