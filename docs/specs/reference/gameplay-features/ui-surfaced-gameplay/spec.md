...
- The newest log row reveals in short typing steps with a neutral caret and preserves whole display characters while it animates, so partial updates do not leave broken glyphs in the log.
