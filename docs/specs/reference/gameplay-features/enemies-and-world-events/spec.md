...
- Enemies roll a deterministic rarity from `Common`, `Uncommon`, `Rare`, `Epic`, and `Legendary`, with dungeon spawns floored above ordinary field threats and world bosses forced to `Legendary`.
