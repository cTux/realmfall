...
- [`packages/ui-react`](./packages/ui-react/README.md): shared reusable React UI component library.
...
- `packages/ui-react`: `ui-component-library`, `input-and-tooltip-handling`, `internationalization`
