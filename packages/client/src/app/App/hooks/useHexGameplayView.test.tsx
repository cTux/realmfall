...
describe('useHexGameplayView', () => {
  ...
  it('includes queued reinforcement enemies from other involved hexes in the combat roster', async () => {
    const game = createGame(3, 'combat-reinforcement-enemy-view');
    const engagedEnemyId = 'enemy-1,0-0';
    const reinforcingEnemyId = 'enemy-0,1-0';
    game.tiles['0,0'] = {
      coord: { q: 0, r: 0 },
      terrain: 'plains',
      items: [],
    ...
    game.tiles['0,1'] = {
      ...
      terrain: 'plains',
      items: [],
      enemyIds: [reinforcingEnemyId],
    };
    game.enemies[engagedEnemyId] = {
      id: engagedEnemyId,
      enemyTypeId: 'wolf',
      name: 'Wolf',
      coord: { q: 1, r: 0 },
    ...
    game.enemies[reinforcingEnemyId] = {
      id: reinforcingEnemyId,
      enemyTypeId: 'wolf',
      name: 'Wolf',
      coord: { q: 0, r: 1 },
      tier: 2,
    ...
    game.combat!.queuedEnemyIds = [reinforcingEnemyId];
    ...
    expect(latestCombatEnemyIds).toEqual([engagedEnemyId, reinforcingEnemyId]);
