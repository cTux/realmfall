...
export function readInventoryWindowStylesSource(
  ...
  return readFileSync(
    resolve(process.cwd(), 'src/ui/components/InventoryWindow/styles.module.scss'),
    'utf8',
  );
}
...
export function readLogWindowStylesSource(readFileSync: typeof readFileSyncType) {
  return readFileSync(
