import { defineGameConfig } from './game/gameConfigSchema';
...
const gameConfig = defineGameConfig({
  balance: {
    ...
    enemy: {
      ...
      treasureGoblin: {
        // Multiplier applied to treasure goblin HP over the ordinary legendary baseline.
        hpMultiplier: 20,
        // Minimum hits a treasure goblin can take before its flee logic triggers.
        fleeHitsMin: 3,
        // Maximum hits a treasure goblin can take before its flee logic triggers.
        fleeHitsMax: 5,
        // Hex radius treasure goblins can use for flee-targeting logic.
        fleeRadius: 10,
      },
    },
    items: {
  ...
  worldGeneration: {
    ...
    enemySpawn: {
      ...
      tile: 0.2,
      treasureGoblin: {
        // Chance that an eligible ordinary single-enemy overworld hostile resolves as a treasure goblin.
        chance: 0.005,
      },
    },
    ambush: {
  ...
  drops: {
    enemyGold: {
      ...
      // Multiplier applied to treasure goblin gold rewards.
    ...
    enemyItem: {
      ...
      treasureGoblin: {
        // Multiplier applied to treasure goblin item-drop success checks.
        chanceMultiplier: 3,
        // Multiplier applied to treasure goblin item-drop rarity scaling.
        rarityMultiplier: 3,
      },
