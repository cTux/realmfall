...
Load `docs/RULES.md` first, then apply only the scoped files under
`docs/rules/` that match the current task.

## Copilot Notes

- Keep this file minimal. Store recurring repository guidance in
